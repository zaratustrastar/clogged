...
contract RealHookDeploymentTest is Test, IUnlockCallback {
    ...
    function setUp() public {
        ...
        market = new ClogMarket(address(hook), address(token), address(tickerNFT), TICKER_TOKEN_ID, multisig, VIRTUAL_ETH_SEED, BUFFER_MULTIPLIER_BPS, address(new NoopEligibility()));
